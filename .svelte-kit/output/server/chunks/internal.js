import { o as object_prototype, a as array_prototype, U as UNINITIALIZED, g as get_descriptor, b as get_prototype_of, i as is_array, H as HYDRATION_ERROR, c as is_extensible, r as run_all, d as index_of, e as define_property, f as HYDRATION_START, h as HYDRATION_END, j as array_from, k as is_passive_event, l as render, p as push$1, s as setContext, m as pop$1 } from "./index2.js";
...
const options = {
  ...
  templates: {
    app: ({ head, body, assets: assets2, nonce, env }) => '<!DOCTYPE html>\n<html lang="en">\n	<head>\n		<meta charset="utf-8" />\n		<link rel="icon" href="' + assets2 + '/favicon.png" />\n		<meta name="viewport" content="width=device-width, initial-scale=1" />\n		' + head + `
		...
		<script src="https://cdn.jsdelivr.net/npm/mathjax@3/es5/mml-mml.js"><\/script>
		<script>
			MathJax = {
				loader: { load: ['input/asciimath'] },
				startup: {
					typeset: false, // We'll manually trigger typesetting
					ready: () => {
	...
	<body data-sveltekit-preload-data="hover">
		<div><div style="display: contents">` + body + "</div></div>\n	</body>\n</html>\n",
